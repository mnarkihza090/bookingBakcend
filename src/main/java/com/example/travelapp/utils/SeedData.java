...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<Hotel> hotels = Arrays.asList(
                ...
                new Hotel("Hotel Ankara", "Turkey", 80, "Ankara", "Comfortable stay in Ankara", 120.0, Arrays.asList("image3.avif", "image4.avif"), "4 stars", Arrays.asList("Free Breakfast", "Gym")),
                new Hotel("Hotel New York", "USA", 200, "New York", "Luxurious hotel in New York", 300.0, Arrays.asList("image5.avif", "image6.avif"), "5 stars", Arrays.asList("Spa", "Bar")),
                new Hotel("Hotel Los Angeles", "USA", 150, "Los Angeles", "Modern hotel in Los Angeles", 250.0, Arrays.asList("image7.avif", "image8.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Toronto", "Canada", 120, "Toronto", "Cozy hotel in Toronto", 180.0, Arrays.asList("image9.avif", "image10.avif"), "4 stars", Arrays.asList("Free WiFi", "Pool")),
                new Hotel("Hotel Vancouver", "Canada", 90, "Vancouver", "Charming hotel in Vancouver", 160.0, Arrays.asList("image11.avif", "image12.avif"), "3 stars", Arrays.asList("Free Breakfast", "Gym")),
                new Hotel("Hotel Paris", "France", 130, "Paris", "Elegant hotel in Paris", 220.0, Arrays.asList("image13.avif", "image14.avif"), "5 stars", Arrays.asList("Spa", "Bar")),
                new Hotel("Hotel Rome", "Italy", 110, "Rome", "Historic hotel in Rome", 200.0, Arrays.asList("image15.avif", "image16.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Tokyo", "Japan", 170, "Tokyo", "Stylish hotel in Tokyo", 280.0, Arrays.asList("image17.webp", "image18.avif"), "5 stars", Arrays.asList("Free WiFi", "Pool")),
                new Hotel("Hotel Kyoto", "Japan", 95, "Kyoto", "Traditional hotel in Kyoto", 150.0, Arrays.asList("image19.avif", "image20.avif"), "4 stars", Arrays.asList("Free Breakfast", "Gym")),
                new Hotel("Hotel Sydney", "Australia", 140, "Sydney", "Seaside hotel in Sydney", 240.0, Arrays.asList("image21.avif", "image22.avif"), "5 stars", Arrays.asList("Spa", "Bar")),
                new Hotel("Hotel Melbourne", "Australia", 100, "Melbourne", "Modern hotel in Melbourne", 220.0, Arrays.asList("image23.avif", "image24.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Dubai", "UAE", 200, "Dubai", "Luxury hotel in Dubai", 400.0, Arrays.asList("image25.avif", "image26.avif"), "5 stars", Arrays.asList("Free WiFi", "Pool")),
                new Hotel("Hotel Abu Dhabi", "UAE", 150, "Abu Dhabi", "Elegant hotel in Abu Dhabi", 350.0, Arrays.asList("image27.avif", "image28.avif"), "5 stars", Arrays.asList("Free Breakfast", "Gym")),
                new Hotel("Hotel London", "UK", 180, "London", "Classic hotel in London", 280.0, Arrays.asList("image29.avif", "image30.avif"), "5 stars", Arrays.asList("Spa", "Bar")),
                new Hotel("Hotel Edinburgh", "UK", 90, "Edinburgh", "Charming hotel in Edinburgh", 160.0, Arrays.asList("image31.avif", "image32.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Berlin", "Germany", 140, "Berlin", "Modern hotel in Berlin", 200.0, Arrays.asList("image33.webp", "image34.avif"), "4 stars", Arrays.asList("Free WiFi", "Pool")),
                new Hotel("Hotel Munich", "Germany", 110, "Munich", "Traditional hotel in Munich", 180.0, Arrays.asList("image35.jpeg", "image36.avif"), "3 stars", Arrays.asList("Free Breakfast", "Gym")),
                new Hotel("Hotel Rio", "Brazil", 130, "Rio de Janeiro", "Beachfront hotel in Rio", 220.0, Arrays.asList("image37.avif", "image38.webp"), "4 stars", Arrays.asList("Spa", "Bar")),
                new Hotel("Hotel Sao Paulo", "Brazil", 150, "Sao Paulo", "Urban hotel in Sao Paulo", 200.0, Arrays.asList("image39.avif", "image40.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Moscow", "Russia", 160, "Moscow", "Luxury hotel in Moscow", 260.0, Arrays.asList("image41.avif", "image42.avif"), "5 stars", Arrays.asList("Free WiFi", "Pool")),
                new Hotel("Hotel St Petersburg", "Russia", 120, "St Petersburg", "Charming hotel in St Petersburg", 200.0, Arrays.asList("image43.avif", "image44.webp"), "4 stars", Arrays.asList("Free Breakfast", "Gym")),

                new Hotel("Hotel Barcelona", "Spain", 110, "Barcelona", "Cozy hotel in Barcelona", 180.0, Arrays.asList("image47.webp", "image48.avif"), "4 stars", Arrays.asList("Parking", "Restaurant")),
                new Hotel("Hotel Beijing", "China", 180, "Beijing", "Modern hotel in Beijing", 260.0, Arrays.asList("image49.webp", "image50.avif"), "5 stars", Arrays.asList("Free WiFi", "Pool"))
